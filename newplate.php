...
<div>
    <form action="">
        ...
        <div class="container"> 
            ...
            <input name="img" id="img" type="img"> 
        </div>
</div>
<?php 
    if (isset($_GET['title']) && isset($_GET['category']) && isset($_GET['img']) && isset($_GET['description'])) {
        $title = $_GET['title'];
        ...
        echo "<div class='card'>";
        echo "<img src='".$newPlate['img']."' alt=''>";
        echo "<h2>".$newPlate['title']."</h2>";
        echo "<p>".$newPlate['description']."</p>";
        echo "<p>".$newPlate['category']."</p>";
        echo "</div>";
    }
?>
